...
def Table2():
    ...
    for DATASET in DATASETS:
        ...
        for i in range(len(representations)):
            ...
            results[DATASETS.index(DATASET)][i][0][0],results[DATASETS.index(DATASET)][i][0][1],results[DATASETS.index(DATASET)][i][1][0],results[DATASETS.index(DATASET)][i][1][1] = cross_validation(representations[i][0],representations[i][1],cv,SVC(C=Cs[DATASET]))
